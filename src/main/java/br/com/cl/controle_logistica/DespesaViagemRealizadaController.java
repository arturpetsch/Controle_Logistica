...
public class DespesaViagemRealizadaController implements Initializable {
    ...
    public void inserirDespesa(ActionEvent action){
        ...
        if (this.viagemDespesa == null) {
            this.viagemDespesa = new ViagemDespesa();
        }

        if (coletarDadosDespesas()) {
    ...
    private void popularComboBoxTipoDespesa(){
     ...
     /**
     * Método que possibilita a outras classes coletar o arraylist de despesas da tabela.
     */
    ...
    /**
     * Metodo que recebe uma lista de despesas da tela ViagemController e mostra na tabela de despesas.
     * @param despesasViagem 
     */
    public void setDespesas(ArrayList<ViagemDespesa> despesasViagem){
        this.despesas = despesasViagem;
        popularTabelaViagem();
    }
}
